...
export default function DailyLog() {
  ...
  // 共通のカードスタイル
  const cardClass =
    "mb-4 rounded-xl border border-amber-200 bg-parchment/70 px-4 py-3 shadow-sm";
      ...
      <div className="mx-auto max-w-xl px-4 pb-10 pt-6">
        ...
        <div className={cardClass}>
          ...
          <input
            ...
            max={3}
            value={shadows}
            onChange={(e) => setShadows(Number(e.target.value) || 0)}
        ...
        <div className={cardClass}>
          ...
          <input
            ...
            onChange={(e) => setPermissionGiven(Number(e.target.value) || 0)}
            className="mt-1 w-20 rounded-md border border-amber-200 bg-parchment px-2 py-1 text-sm"
          />
        </div>
        ...
        <div className={cardClass}>
          ...
          <input
            ...
            onChange={(e) => setBordersCrossed(Number(e.target.value) || 0)}
            className="mt-1 w-20 rounded-md border border-amber-200 bg-parchment px-2 py-1 text-sm"
          />
        </div>
